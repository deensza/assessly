...
def execute_code_in_sandbox(code: str, test_input: str, timeout_seconds: int = 3) -> dict:
    ...
    if not client:
        ...
        return {"output": "Mock output. Docker is not available.", "error": "", "time_ms": 150}
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            try:
                ...
                container.kill()
                return {"output": "", "error": "Timeout exceeded", "time_ms": timeout_seconds * 1000}
            ...
            return {"output": "", "error": f"Execution failed: {str(e)}", "time_ms": 0}
        finally:
            if container:
                try:
